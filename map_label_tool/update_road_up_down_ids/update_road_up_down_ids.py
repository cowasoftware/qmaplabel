...
from qgis.core import QgsLayerTreeModel, QgsProject, QgsVectorLayer
from qgis.PyQt.QtCore import QVariant

from ...utils import *
from ..update_attribute import *
from .update_road_up_down_ids_ui import *


class update_road_up_down_ids(QDialog):
    def __init__(self,parent=None):
        super().__init__(parent)

        
        self.ui_data = Ui_Dialog_update_road_up_down_ids()
    ...
    def btn_run(self):
        ...
        tool_fixing_road_lines_up_down_ids(center_layer,0.0001)
